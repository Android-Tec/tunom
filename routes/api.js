...
var fs = require('fs');
var creatorList = ['@Android-Technology'];
...
loghandler = {
    notparam: {
        ...
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'parâmetros de entrada de apikey',
        getApikey: 'No tienes un apikey?\ncontactese con wa.me/5593991919748 para obtener una api valida'
    },
    notkey: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'verifique el apikey'
    },
    noturl: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'verifique la url'
    },
    notkata: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros kata'
    },
    nottext: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros text'
    },
    nottext2: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros text2'
    },
    notnabi: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros nabi'
    },
    nottext3: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros text3'
    },
    nottheme: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros theme'
    },
    notusername: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros username'
    },
    notvalue: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros value'
    },
    notheme: {
    	status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'o tema não está disponível, por favor, digite texmaker/list atau baca documentasi'
     },
    invalidKey: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'Error su api es invalida contactese con wa.me/5593991919748 para obtener una api valida'
    },
    invalidlink: {
        status: false,
        creador : `${creator}`,
        mensaje : 'erro, talvez seu link seja inválido.'
    },
    invalidkata: {
        status: false,
        creador : `${creator}`,
        mensaje : 'erro, talvez a palavra não esteja na api.'
    },
    notAddApiKey: {
        status: false,
        creador : `${creator}`,
        codigo : 404 ,
        mensaje : 'insira os parâmetros status, apikeyInput, email, nomorhp, name, age, country, exp'
    },
    error: {
        status: false,
        creador : `${creator}`,
        mensaje : 'talvez esteja sendo consertado'
    }
}
const listkey = ["komi-san", "androidtec", "androidtechnology"];
var len = 15
...
if(!Apikey) return res.json(loghandler.notparam)
	if(listkey.includes(Apikey)){    
       fetch(encodeURI(`https://supra-api.herokuapp.com/api/tradutor?text=${text}&apikey=xd`))
...
router.get('/base', async (req, res, next) => {
	var type = req.query.type,
		...
		if (!type) return res.json({status: false, creator, code: 404, mensaje : 'insira os parâmetros type, type yang tersedia : base64 , base32'})
